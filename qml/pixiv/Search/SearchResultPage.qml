...
MyPage {
    ...
    QtObject {
        ...
        function getCount(){
            ...
            view.model.clear();
            currentPage = 0;
            var opt = {"s_mode": searchMode, "order": order, "word": word, "scd": scd};
            function s(resp){
                loading = false;
        ...
        function getlist(option){
            ...
            option = option || "renew";
            var opt = {"s_mode": searchMode, "order": order, "word": word, "scd": scd, "model": view.model};
            if (option == "renew"){
                opt.renew = true;
                currentPage = 1;
                opt.p = 1;
